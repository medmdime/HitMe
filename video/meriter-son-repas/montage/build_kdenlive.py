...
F = lambda n: os.path.join(RUSH, n)
CLIPS = {
    "lit":     R("assets/broll/lit-A.mp4"),
    "cam1":    F("video-2.mp4"),
    "cam2":    T("00-26-53"),
    "cam3":    T("00-28-18"),
    "vx_hook": F("lit-audio-1.mp4"),
    "vx_A":    F("01-decoupe-tdee.mp4"),
    "vx_B":    F("02-digestion-vs-sport.mp4"),
    "vx_C":    F("03-les-trois-leviers.mp4"),
...
TIMELINE = {
 ...
 "incrustation": [                              # tout le montage
   ...
   (None,   13.51, 0.00, 18.01, None),
   ("anim1",18.01, 0.00, 17.50, None),
   ("cam2", 35.51, 0.73, 2.97, None),
   ("anim2",37.75, 0.00, 5.50, None),
   ("cam3", 43.25, 0.41, 5.07, None),
   ("anim3",47.91, 0.00, 25.50, None),
   (None,   73.41, 0.00, 85.41, None),          # TROU — pickup B (la chute)
 ],
 "A1": [                                        # voix seule
   ("vx_hook", 0.31, 0.00, 3.90, 1.0),
   ("cam1_a",   5.04, 0.28, 8.75, 1.0),
   ("vx_A",    18.01, 0.04, 17.54, 1.0),
   ("cam2_a",  35.51, 0.73, 2.97, 1.0),
   ("vx_B",    38.01, 0.00, 5.24, 1.0),
   ("cam3_a",  43.25, 0.41, 5.07, 1.0),
   ("vx_C",    47.91, 0.04, 24.90, 1.0),
 ],
 "A2": [                                        # musique — deux mouvements
   ("music",  5.04, 0.00, 41.96, 0.11),
   ("music", 46.00, 60.00, 99.41, 0.24),
 ],
 "A3": [                                        # risers — 3 emplois, pas un de plus
   ("riser",  4.04, 0.00, 1.88, 0.24),
   ("riser", 45.60, 0.00, 1.88, 0.24),
   ("riser", 72.40, 0.00, 1.88, 0.24),
 ],
 "A4": [                                        # impacts
   ("impact",  5.04, 0.00, 1.50, 0.43),
   ("impact", 46.62, 0.00, 1.50, 0.43),
   ("impact", 73.41, 0.00, 1.50, 0.43),
 ],
 "A5": [                                        # whoosh — à peine audible, il lisse la coupe
   ("woosh",  4.90, 0.00, 0.90, 0.09),
   ("woosh", 46.40, 0.00, 0.90, 0.09),
   ("woosh", 73.25, 0.00, 0.90, 0.09),
 ],
}
...
MARKERS = [(13.51, "PICKUP A — « Sauf que le sport, c'est cinq pour cent de ce que tu brules. Cinq. »"),
           (43.25, "LE TURN — bascule musicale + riser/whoosh/impact"),
           (73.41, "PICKUP B — la chute, 12 s, A REFILMER")]
