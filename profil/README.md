...
**Mohamed Elmdimegh · les calories, sans régime et sans jugement.** Deux formats, trois
publications par semaine, jusqu'au semi-marathon du dimanche 18 octobre 2026.

Ce dossier est la source de vérité du profil. Quatre documents, à lire dans cet ordre :

| Document | Ce qu'il contient | Quand le relire |
|---|---|---|
| `FONDAMENTAUX.md` | qui tu es, ce que tu défends, à qui tu parles, le ton, la signature, le tournage | avant d'écrire un script ou une légende |
| `PROGRAMME-FONDAMENTAUX.md` | la liste des 24 vidéos de base, la méthode d'écriture, le script de la vidéo « huile », le plan « corps cible », le trailer, la règle YouBud | avant d'écrire une vidéo science |
| `YAPPING-SEMI.md` | la règle du yapping, le gabarit en cinq lignes, le générateur, les douze épisodes écrits, ce qu'il faut filmer, la règle de montage | avant chaque séance filmée |
| `PLAN-SEMI-18-OCTOBRE.md` | la semaine par semaine, le journal | le dimanche soir |
...
6. **Dans un yapping, tu ne racontes jamais ce que tu as fait. Tu racontes ce que ça prouve.** Chaque épisode ouvre par « Si tu… ».
7. **Chaque chiffre est produit à l'écran** et a une échelle humaine : des cuillères d'huile, des journées de bouffe. Jamais un nombre nu.
8. **Sans jugement**, parce que tu as jugé une fois, et que c'était ta mère. Son histoire ne se dit à l'image qu'avec son accord.
9. **Instagram maison, TikTok et Shorts en miroir.** YouBud dans la bio, dans une vidéo seulement quand elle a besoin du calcul.
...
| Jour | Ce que tu fais | Ce que tu publies |
|---|---|---|
| lundi | écriture de la science de la semaine, lecture à voix haute | |
| mardi | renfo des jambes : **b-roll**, sans parler. Face caméra de la science le soir | |
| mercredi | fractionné : **b-roll**, puis le **yapping A** en marchant, deux prises | **yapping A** |
| jeudi | rendu de l'assiette, montage de la science | |
| vendredi | export, légende en cinq parties | **science** |
| samedi | social puis haut du corps : **b-roll**, sans parler | |
| dimanche | sortie longue : b-roll, puis le **yapping B**. Le soir, le journal et le tableau des kilomètres | **yapping B** |

Entre sept et neuf heures de travail, b-roll compris. Si une semaine casse, c'est la
science qui glisse d'une semaine, jamais le yapping : la série ne peut pas avoir de trou.

---

## Le calendrier

| Sem. | Dates | Yapping A (mer) | Science (ven) | Yapping B (dim) |
|---|---|---|---|---|
| **S1** | 7 → 13 sept | A1 · le fractionné brûle moins que ce qu'on te dit | **« Tu n'as jamais eu à le mériter »**, deux pickups et c'est fini. Le trailer sort le même jour et s'épingle | B1 · l'hypothèse, épinglé |
...
version lourde « cardio et muscle » attendent le 19 octobre.
